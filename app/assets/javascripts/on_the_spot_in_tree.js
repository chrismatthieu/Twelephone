$(document).ready(function() {
    ...
    $(".on_the_spot_in_tree_editing").mouseover(function() {
        $(this).css('background-color', '#ffee79');
    });
    $(".on_the_spot_in_tree_editing").mouseout(function() {
        $(this).css('background-color', 'inherit');
    });
    $('.on_the_spot_in_tree_editing').each(function(n){
        var el           = $(this),
